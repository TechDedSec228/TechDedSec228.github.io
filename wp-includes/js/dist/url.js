 ...
 * @example
 * ```js
 * const isURL = isURL( 'https:.org' ); // true
 * ```
 *
 ...
 * const protocol2 = getProtocol( 'https:.org' ); // 'https:'
 * ```
 *
 ...
 * @example
 * ```js
 * const authority1 = getAuthority( 'https:.org/help/' ); // 'wordpress.org'
 ...
 * const path2 = getPath( 'https:.org/help/faq/' ); // 'help/faq'
 * ```
 *
 ...
 * const pathAndQueryString2 = getPathAndQueryString( 'https:.org/help/faq/' ); // '/help/faq'
 * ```
 *
 ...
 * const fragment2 = getFragment( 'https:.org#another-fragment?query=true' ); // '#another-fragment'
 * ```
 *
 ...
 * @example
 * ```js
 * const foo = getQueryArg( 'https:.org?foo=bar&bar=baz', 'foo' ); // bar
 * ```
 *
 ...
 * @example
 * ```js
 * const hasBar = hasQueryArg( 'https:.org?foo=bar&bar=baz', 'bar' ); // true
 * ```
 *
 ...
 * @example
 * ```js
 * const newUrl = removeQueryArgs( 'https:.org?foo=bar&bar=baz&baz=foobar', 'foo', 'bar' ); // https:.org?baz=foobar
 * ```
 *
 ...
 * @example
 * ```js
 * const actualURL = prependHTTP( 'wordpress.org' ); // .org
 * ```
 *
